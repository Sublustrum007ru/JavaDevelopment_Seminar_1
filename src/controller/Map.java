...
public class Map extends JPanel {
    ...
    void startNewGame(int mode, int sizeX, int sizeY, int wLen) {
        this.mode = mode;
        ...
        for (int y = 0; y < fieldSizeY; y++) {
            for (int x = 0; x < fieldSizeX; x++) {
                ...
                if(field[y][x] == HUMAN_DOT){
                    ...
                    g.drawLine(x * cellWidth + PADDING, (y + 1) * cellHeight + PADDING, (x + 1) * cellWidth - PADDING, y * cellHeight + PADDING);
                }else if(field[y][x] == AI_DOT){
                    g.drawOval(x * cellWidth + PADDING, y * cellHeight + PADDING, cellWidth - PADDING * 2, cellHeight - PADDING * 2);
                }else{
